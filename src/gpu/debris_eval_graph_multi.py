...
def graph_eval(input_graph_def, input_node, output_node):
  ...
  test_X, test_Y = ds.load_debris_rocket_hw(_num=400, _norm_range=norm_range, filename="test.log", randomly=False)
  ...
  result = au.prediction_mcdo2(prediction, ds, test_X, test_Y, norm_range, file_list, 1)
  return
  total_diff = 0
